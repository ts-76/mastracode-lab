...
function detectProject(projectPath) {
  ...
  const baseName = gitUrl ? ((_a2 = gitUrl.split("/").pop()) == null ? void 0 : _a2.replace(/\.git$/, "")) || "project" : path__default.default.basename(rootPath);
...
//# sourceMappingURL=chunk-4H755EGM.cjs.map
//# sourceMappingURL=chunk-4H755EGM.cjs.map